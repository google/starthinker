...
Convert given census table to percent of population, normalizing it.
  ...
  - Specify the geography, year, and span that make up the 1-census table names.
  ...
  1-census table names: https://pantheon.corp.google.com/bigquery?redirect_from_classic=true&p=bigquery-public-data&d=census_bureau_acs&page=dataset
