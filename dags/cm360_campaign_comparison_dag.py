...
Group KPIs into cohorts and compare performance across time and geography. Quickly discover where national and local campaigns need to be targeted, funded, or optimized.
  ...
  - After recipe completes make a copy of the <a href='https://datastudio.google.com/c/u/0/reporting/e34669ec-0894-4453-9ac4-ae9c3e739c48/page/p_pkxetkzemc' target='_blank'>Campaign Comparison Dashboard</a>. Keep the dta source as is on the copy screen.
  - After the copy is made, click Edit->Resource->Manage Added Data Sources->CC_Report->Edit->Edit Connection.
  - Connect to the newly created <b>BigQuery->->_Campaign_Comparison->Comparison</b> table.
