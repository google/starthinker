...
Execute any Google API function and store results to BigQuery.
  ...
  - The 1-API Key may be required for some calls.
  - The 2-Developer Token may be required for some calls.
  - Give BigQuery dataset and table where response will be written.
  - All API calls are based on 3-discovery document, for example the 4-Campaign Manager API.

  1-API Key: https://cloud.google.com/docs/authentication/api-keys
  2-Developer Token: https://developers.google.com/google-ads/api/docs/first-call/dev-token
  3-discovery document: https://developers.google.com/discovery/v1/reference
  4-Campaign Manager API: https://developers.google.com/display-video/api/reference/rest/v1/advertisers/list
