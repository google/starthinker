...
from starthinker.task.cm_to_dv.run import cm_to_dv


def recipe_cm360_to_dv360(config, auth_dv, auth_cm, auth_sheet, auth_bigquery, recipe_name, recipe_slug, command):
...
if __name__ == "__main__":
  ...
  parser.add_argument("-auth_cm", help="Credentials used for dv.", default='user')
  ...
  recipe_cm360_to_dv360(config, args.auth_dv, args.auth_cm, args.auth_sheet, args.auth_bigquery, args.recipe_name, args.recipe_slug, args.command)
