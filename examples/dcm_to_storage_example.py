...
if __name__ == "__main__":
  ...
  parser.add_argument("-bucket", help="", default='')
  parser.add_argument("-path", help="", default='CM_Report')
  ...
  recipe_dcm_to_storage(config, args.auth_read, args.auth_write, args.account, args.report_id, args.report_name, args.bucket, args.path)
