  ...
  parser = argparse.ArgumentParser(
    ...
    description=textwrap.dedent("""
      GoogleAds funnel analysis using Census data.
        ...
        3. Copy <a href='https://datastudio.google.com/c/u/0/reporting/3673497b-f36f-4448-8fb9-3e05ea51842f/' target='_blank'>GoogleAds Segmentology Sample</a>. Leave the Data Source as is, you will change it in the next step.
