...
if __name__ == "__main__":
  ...
  recipe_trends_places_to_bigquery_via_query(config, args.auth_write, args.secret, args.key, args.places_dataset, args.places_query, args.places_legacy, args.destination_dataset, args.destination_table)
