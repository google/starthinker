...
def recipe_trends_places_to_sheets_via_query(config, auth_write, secret, key, places_dataset, places_query, places_legacy, destination_sheet, destination_tab):
...
if __name__ == "__main__":
  ...
  recipe_trends_places_to_sheets_via_query(config, args.auth_write, args.secret, args.key, args.places_dataset, args.places_query, args.places_legacy, args.destination_sheet, args.destination_tab)
