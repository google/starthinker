        ...
        },
         {
             ...
             'fields': [
                 ...
                 [{
                     ...
                     'description':
                         'AUDIO, FLASH, HTML, HTML_IMAGE, IMAGE, VIDEO',
                     'name':
                         'type',
                     'type':
                         'STRING',
                 ...
                 [{
                     ...
                     'description':
                         ...
                         'ASSET_DURATION_TYPE_CUSTOM, ASSET_DURATION_TYPE_NONE',
                     'name':
                         'durationType',
                     'type':
                         'STRING',
        ...
        [{
            ...
            'fields': [{
                'description':
                    ...
                    'VIDEO_FULLSCREEN, VIDEO_MIDPOINT, VIDEO_MUTE, '
                    'VIDEO_PAUSE, VIDEO_PROGRESS, VIDEO_REWIND, VIDEO_SKIP, '
            ...
            'description':
                ...
                'RICH_MEDIA_MOBILE_IN_APP, RICH_MEDIA_PEEL_DOWN, '
                'TRACKING_TEXT, VPAID_LINEAR_VIDEO, VPAID_NON_LINEAR_VIDEO',
            'name':
                'type',
            'type':
                'STRING',
