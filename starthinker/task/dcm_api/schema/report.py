...
report_Schema = [{
        ...
        'mode': 'REPEATED'
               ...
               [{
                   ...
                   'description':
                       ...
                       'QUARTER_TO_DATE, TODAY, WEEK_TO_DATE, YEAR_TO_DATE, '
                       'YESTERDAY',
                   'name':
                       'relativeDateRange',
                   'type':
    ...
    'fields': [
        ...
        [{
            ...
            'description':
                ...
                'PREVIOUS_YEAR, QUARTER_TO_DATE, TODAY, WEEK_TO_DATE, '
    ...
    'description':
        'CROSS_DIMENSION_REACH, FLOODLIGHT, PATH_TO_CONVERSION, REACH, STANDARD',
    'name':
        'type',
    'type':
        'STRING',
