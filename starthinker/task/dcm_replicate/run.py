...
def dcm_replicate_accounts():
  if project.verbose: print('DCM REPLICATE ACCOUNTS')
...
def dcm_replicate_template():
  if project.verbose: print('DCM REPLICATE TEMPLATE')
...
def dcm_replicate_create(account, advertisers, name, template):
  ...
  body = report_filter(
    ...
    { "accountId": { "values": account },
      "dfa:advertiser": { "values":advertisers }
    }
  )
  body['name'] = name
...
def dcm_replicate():
  if project.verbose: print('DCM REPLICATE')
