...
class StringExtensions:
	...
	def convertDateStrToDateTimeStr(date, time='00:00:00'):
		...
		Returns:
			A string representation of a datetime in the following format YYYY-MM-DDTHH:mm:SSZ
		'''
		if not date == None:
	...
	def convertDateTimeStrToDateStr(datetime):
		...
		Returns:
			A string representation of the date in the following format YYYY-MM-DD
		'''
