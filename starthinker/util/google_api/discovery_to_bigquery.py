...
# Submitting a BigQuery table schema with a field whose a description longer
# than this will cause a 400 error.
      ...
      if '$ref' in value:
        ...
        if value['type'] == 'array':
          ...
          if '$ref' in value['items']:
            ...
            bigquery_schema.append({
                # Truncate description fields generated by possible enum values to prevent errors.
                'description': ', '.join(value['items'].get('enum', []))[:_MAX_DESCRIPTION_LENGTH],
                'name': key,
          ...
          bigquery_schema.append({
              # Truncate description fields generated by possible enum values to prevent errors.
              'description': ', '.join(value.get('enum', []))[:_MAX_DESCRIPTION_LENGTH],
              'name': key,
