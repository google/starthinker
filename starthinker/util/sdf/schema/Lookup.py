...
SDF_COLUMNS = "Line_Item_Id, Io_Id, Type, Subtype, Name, Timestamp, Status, Start_Date, End_Date, Budget_Type, Budget_Amount, Pacing, Pacing_Rate, Pacing_Amount,	Frequency_Enabled, Frequency_Exposures, Frequency_Period, Frequency_Amount, Trueview_View_Frequency_Enabled, Trueview_View_Frequency_Exposures, Trueview_View_Frequency_Period, Partner_Revenue_Model, Partner_Revenue_Amount, Conversion_Counting_Type, Conversion_Counting_Pct, Conversion_Pixel_Ids, Fees, Integration_Code, Details, Bid_Strategy_Type, Bid_Strategy_Value, Bid_Strategy_Unit, Bid_Strategy_Do_Not_Exceed, Creative_Assignments, Geography_Targeting_Include, Geography_Targeting_Exclude, Language_Targeting_Include, Language_Targeting_Exclude, Device_Targeting_Include, Device_Targeting_Exclude, Browser_Targeting_Include, Browser_Targeting_Exclude, Brand_Safety_Labels, Brand_Safety_Sensitivity_Setting, Brand_Safety_Custom_Settings, Third_Party_Verification_Services, Third_Party_Verification_Labels, Channel_Targeting_Include, Channel_Targeting_Exclude, Site_Targeting_Include, Site_Targeting_Exclude, App_Targeting_Include, App_Targeting_Exclude, Category_Targeting_Include, Category_Targeting_Exclude, Keyword_Targeting_Include, Keyword_Targeting_Exclude, Audience_Targeting_Similar_Audiences, Audience_Targeting_Include, Audience_Targeting_Exclude, Affinity_In_Market_Targeting_Include, Affinity_In_Market_Targeting_Exclude, Custom_Affinity_Targeting, Inventory_Source_Targeting_Include, Inventory_Source_Targeting_Exclude, Daypart_Targeting, Environment_Targeting, Viewability_Targeting_Active_View, Viewability_Targeting_Ad_Position_Include, Viewability_Targeting_Ad_Position_Exclude, Video_Ad_Position_Targeting, Video_Player_Size_Targeting, Demographic_Targeting_Gender, Demographic_Targeting_Age, Connection_Speed_Targeting, Carrier_Targeting_Include, Carrier_Targeting_Exclude, Trueview_Mobile_Bid_Adjustment_Option, Trueview_Mobile_Bid_Adjustment_Percentage, Trueview_Category_Exclusions_Targeting, Trueview_Inventory_Source_Targeting"
...
SDF_FILE_TYPE_COLUMNS = {
	"AD": [
		...
		"Trueview_View_Frequency_Period",
		"Partner_Revenue_Model",
		"Partner_Revenue_Amount",
		"Conversion_Counting_Type",
		"Conversion_Counting_Pct",
		...
		"Bid_Strategy_Value",
		"Bid_Strategy_Unit",
		"Bid_Strategy_Do_Not_Exceed",
		"Creative_Assignments",
		"Geography_Targeting_Include",
		"Geography_Targeting_Exclude",
		"Language_Targeting_Include",
		"Language_Targeting_Exclude",
		"Device_Targeting_Include",
		"Device_Targeting_Exclude",
		"Browser_Targeting_Include",
		"Browser_Targeting_Exclude",
		"Brand_Safety_Labels",
		"Brand_Safety_Sensitivity_Setting",
		"Brand_Safety_Custom_Settings",
		"Third_Party_Verification_Services",
		"Third_Party_Verification_Labels",
		"Channel_Targeting_Include",
		"Channel_Targeting_Exclude",
		"Site_Targeting_Include",
		"Site_Targeting_Exclude",
		"App_Targeting_Include",
		"App_Targeting_Exclude",
		"Category_Targeting_Include",
		"Category_Targeting_Exclude",
		"Keyword_Targeting_Include",
		...
		"Custom_Affinity_Targeting",
		"Inventory_Source_Targeting_Include",
		"Inventory_Source_Targeting_Exclude",
		"Daypart_Targeting",
		"Environment_Targeting",
		"Viewability_Targeting_Active_View",
		"Viewability_Targeting_Ad_Position_Include",
		"Viewability_Targeting_Ad_Position_Exclude",
		"Video_Ad_Position_Targeting",
		"Video_Player_Size_Targeting",
		"Demographic_Targeting_Gender",
		"Demographic_Targeting_Age",
		"Connection_Speed_Targeting",
		"Carrier_Targeting_Include",
