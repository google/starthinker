...
class Command(BaseCommand):
  ...
  def handle(self, *args, **kwargs):
    ...
    email = {       
      ...
      "footer":[
        { "text":"Internal UI", "link":"http://go/starthinker" },
        { "text":"Esteemed Solution Gallery", "link":"http://go/esteemed/#/search/StarThinker" },
        { "text":"GitHub Solution Gallery", "link":"https://google.github.io/starthinker/" },
        { "text":"Google3 Repository", "link":"http://go/starthinker-google3" },
        { "text":"GOB Repository ( Official )", "link":"http://go/starthinker-code" },
        { "text":"GitHub Repository", "link":"https://github.com/google/starthinker" }
      ],
    ...
    for s in Script.get_scripts():
      ...
      row = [
        {
          "image":{ "src":s.get_image(), "link":s.get_link_client() }
        },
        {
