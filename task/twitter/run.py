...
def get_twitter_api():
  global TWITTER_API
  if TWITTER_API is None: TWITTER_API = TwitterAPI(project.task['key'], project.task['secret'], auth_type='oAuth2')
  return TWITTER_API


TWITTER_TRENDS_PLACE_SCHEMA = [
  { "name":"Woeid", "type":"INTEGER" },
  { "name":"Name", "type":"STRING" },
  { "name":"Url", "type":"STRING" },
  { "name":"Promoted_Content", "type":"STRING", "mode":"NULLABLE" },
  { "name":"Query", "type":"STRING", },
  { "name":"Tweet_Volume", "type":"INTEGER" },
]
...
TWITTER_TRENDS_CLOSEST_SCHEMA = [
  ...
  { "name":"Place_Type_Code", "type":"INTEGER" },
  { "name":"Place_Type_Name", "type":"STRING" },
  { "name":"URL", "type":"STRING" },
  { "name":"Woeid", "type":"INTEGER" },
]
