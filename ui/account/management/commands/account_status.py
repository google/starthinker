...
from starthinker.ui.website.templatetags.website_app import mailto

EMAIL_FROM = 'starthinker@google.com'
EMAIL_CC = ''
EMAIL_SUBJECT = 'StarThinker Status Update'
EMAIL_PARAGRAPH = 'Here is your weekly job status summary.  StarThinker is sending you this report because you have jobs running in the system.'

HELP_LINKS = [
  { 'name':'Solution Gallery',
    'description':'A list of available solutions you can deploy for clients, their impact, and deployment instructions.',
    'button':{
  ...
  { 'name':'How To Tutorial',
    'description':'Slides that show how to use StarThinker to creat recipes and run solutions.  Includes both technical and point and click examples for CSE / TS / PAS / Sales.',
    'button':{
  ...
  { 'name':'Feature Requests And Bugs',
    'description':'Submit feature requests and help us track down bugs and improve the tool for the whole team.',
    'button':{
  ...
  { 'name':'Technical Documentation',
    'description':'The Product Requirements Document has everything you need to leverage the StarThinker library for the next solution sprint.',
    'button':{
...
#          email.paragraph('Reduce solution delivery to minutes and create custom solutions that exceed clients expectations with these helpful guides and tips.')
          for h in HELP_LINKS:
            email.section(h['name'], h['description'], None, h['button']['link'], h['button']['text'])
