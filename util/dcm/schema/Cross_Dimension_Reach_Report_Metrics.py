...
Cross_Dimension_Reach_Report_Metrics_Schema = [
  ...
  { "name":"Cookie_Reach_Duplicate_Click_Reach", "type":"FLOAT", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Duplicate_Impression_Reach", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Duplicate_Impression_Reach", "type":"FLOAT", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Duplicate_Total_Reach", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Duplicate_Total_Reach", "type":"FLOAT", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Exclusive_Click_Reach", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Exclusive_Click_Reach", "type":"FLOAT", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Exclusive_Impression_Reach", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Exclusive_Impression_Reach", "type":"FLOAT", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Exclusive_Total_Reach", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Cookie_Reach_Exclusive_Total_Reach", "type":"FLOAT", "mode":"NULLABLE" },
