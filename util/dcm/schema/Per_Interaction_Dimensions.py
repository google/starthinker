...
Per_Interaction_Dimensions_Schema = [
  { "name":"Interaction_Number", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Interaction_Date_Time", "type":"DATETIME", "mode":"NULLABLE" },
  ...
  { "name":"Floodlight_Attributed_Interaction", "type":"STRING", "mode":"NULLABLE" },
  ...
  { "name":"Recalculated_Attributed_Interaction", "type":"STRING", "mode":"NULLABLE" },
  ...
  { "name":"Twitter_Impression_Id", "type":"INTEGER", "mode":"NULLABLE" },
  { "name":"Within_Floodlight_Lookback_Window", "type":"STRING", "mode":"NULLABLE" }
]